    ...
    return (
      React.createElement('header', {
        ...
        React.createElement('a', { href: 'index.html', style: { display: 'flex', alignItems: 'center', gap: 14 } },
          React.createElement('img', { src: (window.__resources && window.__resources.logoFull) || 'assets/logos/Doi-DarkBackground.svg', alt: 'Doi Marketing + Design Co.', style: { height: 75, padding: '15px' } })
        ),
      ...
      React.createElement('footer', { style: { borderTop: '1px solid var(--border)', padding: 'var(--space-9) 0 var(--space-7)' } },
        React.createElement('div', { className: 'doi-container doi-footer-grid', style: { display: 'grid', gridTemplateColumns: '1.6fr 1fr 1fr 1fr', gap: 'var(--space-7)' } },
          React.createElement('div', null,
            React.createElement('img', { src: (window.__resources && window.__resources.logoFull) || 'assets/logos/Doi-DarkBackground.svg', alt: 'Doi Marketing + Design Co.', style: { height: 75, marginBottom: 22 } }),
  ...
  function PageHero({ eyebrow, title, emphasis, lede, kicker }) {
    return (
      React.createElement('section', { style: { position: 'relative', borderBottom: '1px solid var(--border)', overflow: 'hidden' } },
        React.createElement('img', { src: (window.__resources && window.__resources.logoIcon) || 'assets/logos/Doi-Icon-darkBK.svg', alt: '', 'aria-hidden': 'true', style: { position: 'absolute', right: '-3%', top: '8%', height: '108%', opacity: 0.04, filter: 'grayscale(1)' } }),
